...
<script>
	...
	url.href = "http://jhgpage.com/FinalProject";
	gitUrl.href = "https://github.com/SangMyoung2/Final";
...
<div class="flex_center">
            <div id="intro_txt_wrap" class="flex_center">
				...
				style=" font-size: 50px; margin-bottom: 10px; font-weight: 600;">
					Final Project - GATCHI
				</a>
                </div>
                <div id="intro_txt_sub" style="letter-spacing: 0;">
                    <a href="http://jhgpage.com/FinalProject">클릭시 해당 프로젝트로 이동합니다</a>
                </div>
            </div>
        </div>
	<div id="content">
...
<script type="text/javascript">
		let me = document.querySelector('[data-menu="GATCHI"]');
		me.classList.add('on');
		
		function gopage(){
			window.location.href = "http://jhgpage.com/FinalProject";
		}
	</script>
</body>
</html>